...
public:
    ...
    void draw_text(float x, float y, const char* text, float r, float g, float b, float a = 1.0f);
...
private:
    ...
    static constexpr uint32_t kAtlasWidth = 512;
    static constexpr uint32_t kAtlasHeight = 512;
