...
struct DeferredEntry {
    ...
    std::vector<std::string> port_repeat_groups;   // stable strings for port repeat_group pointers
    std::vector<std::string> param_repeat_groups;  // stable strings for param repeat_group pointers
