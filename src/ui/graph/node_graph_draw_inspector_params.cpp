...
// Inspector draw-helpers + truncate_text now live in shared headers (audit
// 08-R2-F1/F2/F4): the helpers in node_graph_draw_inspector_helpers.h, the
// canonical truncate_text in ui/rendering/text_util.h.
