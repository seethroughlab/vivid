Vivid hosts CLAP and VST3 plugins. To keep onboarding honest, the beginner path depends on exactly
**one** free plugin, and every required plugin is verified (download, format, architecture, install
path, and missing-plugin recovery) before a tutorial is allowed to require it.

## Required for the first tutorial
...
- **Format:** VST3
- **Role:** the free drum machine used by the *Pulse*, *Neon* and *Mirror* showcases
- Install `Cassette Drums.vst3` **and** its `Cassette Drums.instruments` folder together into
