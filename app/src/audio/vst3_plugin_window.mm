...
Vst3PluginWindow* vst3_plugin_window_open(IEditController* controller, const char* title) {
    ...
    @autoreleasepool {
        ...
        // Make the content view layer-backed. VSTGUI uses Metal/CoreAnimation for
        // rendering and requires a layer-backed parent view — without this, the
        // platform context it builds internally comes up null and crashes.
