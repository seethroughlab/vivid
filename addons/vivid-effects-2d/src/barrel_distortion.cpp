...
void BarrelDistortion::init(Context& ctx) {
...
void BarrelDistortion::createPipeline(Context& ctx) {
...
fn fs_main(input: VertexOutput) -> @location(0) vec4f {
    ...
    bufferDesc.size = sizeof(BarrelDistortionUniforms);
    ...
    entries[0].buffer.minBindingSize = sizeof(BarrelDistortionUniforms);
...
void BarrelDistortion::process(Context& ctx) {
    ...
    bindEntries[0].size = sizeof(BarrelDistortionUniforms);
