...
void Quantize::init(Context& ctx) {
...
void Quantize::createPipeline(Context& ctx) {
...
fn fs_main(input: VertexOutput) -> @location(0) vec4f {
    ...
    bufferDesc.size = sizeof(QuantizeUniforms);
    ...
    entries[0].buffer.minBindingSize = sizeof(QuantizeUniforms);
...
void Quantize::process(Context& ctx) {
    ...
    bindEntries[0].size = sizeof(QuantizeUniforms);
