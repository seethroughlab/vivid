...
void Pixelate::init(Context& ctx) {
...
fn fs_main(input: VertexOutput) -> @location(0) vec4f {
    ...
    bufferDesc.size = sizeof(PixelateUniforms);
    ...
    samplerDesc.magFilter = WGPUFilterMode_Nearest;  // Nearest for crisp pixels
    ...
    entries[0].buffer.minBindingSize = sizeof(PixelateUniforms);
...
void Pixelate::process(Context& ctx) {
    ...
    bindEntries[0].size = sizeof(PixelateUniforms);
