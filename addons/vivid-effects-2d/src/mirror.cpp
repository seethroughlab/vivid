...
fn fs_main(input: VertexOutput) -> @location(0) vec4f {
    ...
    bufferDesc.size = sizeof(MirrorUniforms);
    ...
    entries[0].buffer.minBindingSize = sizeof(MirrorUniforms);
...
void Mirror::process(Context& ctx) {
    ...
    bindEntries[0].size = sizeof(MirrorUniforms);
