...
**Experimentation layer — LLM as clip generator.** "Generate 8 different connection matrix configurations." "Fill this session track with particle behavior clips." The user evaluates and selects. The LLM produces breadth; the user provides taste.
