...
| Chorus | operators/audio/chorus/chorus.cpp | -- | 2 | chorus_metronome_demo, chorus_demo |
| Compressor | operators/audio/compressor/compressor.cpp | -- | 1 | compressor_demo |
| ConvolutionReverb | operators/audio/convolution_reverb/convolution_reverb.cpp | ir_files | 5 | four_on_the_floor, convolution_reverb_mix_bus_fixture, convolution_reverb_pad_fixture, convolution_reverb_percussion_fixture, convolution_reverb_vocal_fixture |
...
| DrumHiHat | operators/audio/drum_hihat/drum_hihat.cpp | -- | 5 | drum_stack_demo, four_on_the_floor, state_machine_demo, showcase_demo, convolution_reverb_percussion_fixture |
| DrumKick | operators/audio/drum_kick/drum_kick.cpp | -- | 6 | drum_stack_demo, four_on_the_floor, state_machine_demo, showcase_demo, av_sync_demo (+1 more) |
| DrumSnare | operators/audio/drum_snare/drum_snare.cpp | -- | 5 | drum_stack_demo, four_on_the_floor, state_machine_demo, showcase_demo, convolution_reverb_percussion_fixture |
| DrumTom | operators/audio/drum_tom/drum_tom.cpp | -- | 1 | drum_stack_demo |
| DualFilter | operators/audio/dual_filter/dual_filter.cpp | -- | 0 | -- |
| Filter | operators/audio/filter/filter.cpp | -- | 13 | filter_sweep, full_synth_patch, star_spin_demo, texture_analysis_demo, chromatic_ghosts (+8 more) |
| Flanger | operators/audio/flanger/flanger.cpp | -- | 1 | flanger_demo |
| FmSynth | operators/audio/fm_synth/fm_synth.cpp | -- | 4 | arpeggiator_metronome_demo, fm_synth_demo, state_machine_demo, arpeggiator_demo |
| Gain | operators/audio/gain/gain.cpp | -- | 37 | chorus_metronome_demo, compressor_demo, filter_sweep, fm_synth_demo, full_synth_patch (+32 more) |
...
| Oscillator | operators/audio/oscillator/oscillator.cpp | -- | 33 | chorus_metronome_demo, compressor_demo, full_synth_patch, granular_synth_demo, sequencer_demo (+28 more) |
...
| Reverb | operators/audio/reverb/reverb.cpp | -- | 4 | arpeggiator_metronome_demo, sequencer_demo, mfi_av_sync_demo, arpeggiator_demo |
...
| Arpeggiator | operators/control/arpeggiator/arpeggiator.cpp | -- | 3 | arpeggiator_metronome_demo, sampler_chromatic_demo, arpeggiator_demo |
| Basename | operators/control/basename/basename.cpp | -- | 1 | mfi_space_cycle_sync_demo |
| ChordProgression | operators/control/chord_progression/chord_progression.cpp | -- | 4 | arpeggiator_metronome_demo, sampler_chromatic_demo, arpeggiator_demo, slicer_demo |
| Clock | operators/control/clock/clock_au.cpp | -- | 19 | compressor_demo, drum_stack_demo, filter_sweep, fm_synth_demo, four_on_the_floor (+14 more) |
| ClockFr | operators/control/clock/clock_fr.cpp | -- | 4 | av_demo, demo, osc_av_loopback_demo, parity_cross_domain |
| DrumKit | operators/control/drum_kit/drum_kit.cpp | -- | 5 | drum_stack_demo, four_on_the_floor, state_machine_demo, showcase_demo, convolution_reverb_percussion_fixture |
| DrumSequencer | operators/control/drum_sequencer/drum_sequencer.cpp | -- | 6 | drum_stack_demo, four_on_the_floor, sp404_demo, state_machine_demo, showcase_demo (+1 more) |
...
| Euclidean | operators/control/euclidean/euclidean.cpp | -- | 1 | chromatic_ghosts |
...
| GateAudio | operators/control/gate/gate.cpp | -- | 0 | -- |
| Keyboard | operators/control/keyboard/keyboard.cpp | -- | 1 | mfi_space_cycle_sync_demo |
| Lfo | operators/control/lfo/lfo_au.cpp | -- | 17 | fm_synth_demo, full_synth_patch, granular_synth_demo, state_machine_demo, stereo_pan_width_demo (+12 more) |
| LfoFr | operators/control/lfo/lfo_fr.cpp | -- | 44 | chorus_metronome_demo, displace_demo, dither_demo, edge_demo, mirror_demo (+39 more) |
| Logic | operators/control/logic/logic.cpp | -- | 0 | -- |
| Macro | operators/control/macro/macro.cpp | -- | 0 | -- |
| Math | operators/control/math/math.cpp | -- | 3 | spirograph_demo, path_animate_av_demo, voronoi_mosaic_demo |
...
| MsegAudio | operators/control/mseg/mseg.cpp | -- | 0 | -- |
| NoteDuration | operators/control/note_duration/note_duration.cpp | -- | 0 | -- |
| NotePattern | operators/control/note_pattern/note_pattern.cpp | -- | 1 | state_machine_demo |
| OscIn | operators/control/osc_in/osc_in.cpp | osc_network | 2 | osc_av_loopback_demo, osc_av_in_demo |
...
| PatternSeq | operators/control/pattern_seq/pattern_seq.cpp | -- | 0 | -- |
| PhaseToMidi | operators/control/phase_to_midi/phase_to_midi.cpp | -- | 0 | -- |
| Quantizer | operators/control/quantizer/quantizer.cpp | -- | 0 | -- |
| Repeat | operators/control/repeat/repeat.cpp | -- | 1 | lanes_intro_demo |
| SampleHoldAudio | operators/control/sample_hold/sample_hold.cpp | -- | 0 | -- |
| Select | operators/control/select/select.cpp | -- | 0 | -- |
| Sequencer | operators/control/sequencer/sequencer.cpp | -- | 1 | sequencer_demo |
...
| Tracker | operators/control/tracker/tracker.cpp | -- | 0 | -- |

## Gpu Operators (26)

| Registered Name | Source | Env Dep | Used In (count) | Graphs |
| --- | --- | --- | --- | --- |
| Bloom | operators/gpu/bloom/bloom.cpp | -- | 15 | state_machine_demo, spirograph_demo, voronoi_cells_demo, bloom_demo, nyan_trail_demo (+10 more) |
| CellularAutomata | operators/gpu/cellular_automata/cellular_automata.cpp | -- | 0 | -- |
| Composite | operators/gpu/composite/composite.cpp | -- | 11 | state_machine_demo, composite_demo, rich_text_demo, showcase_demo, chromatic_ghosts (+6 more) |
| Feedback | operators/gpu/feedback/feedback.cpp | -- | 8 | spirograph_demo, feedback_demo, nyan_trail_demo, star_spin_demo, showcase_demo (+3 more) |
...
| MovieFileIn | operators/gpu/movie_file_in/movie_file_in.cpp | movie_media | 18 | crt_effect_demo, edge_demo, mirror_demo, scanlines_demo, wgsl_filters_demo (+13 more) |
...
| Shape | operators/gpu/shape/shape.cpp | -- | 18 | state_machine_demo, displace_demo, bloom_demo, composite_demo, feedback_demo (+13 more) |
...
| TextureLoader | operators/gpu/texture_loader/texture_loader.cpp | filesystem | 3 | division_raster_demo, qbert_demo, voronoi_mosaic_demo |
...
| Gradient | filters/gradient.wgsl | 6 | dither_demo, wgsl_filters_demo, edge_blend_demo, gradient_demo, switch_demo (+1 more) |
| Halftone | filters/halftone.wgsl | 2 | mfi_halftone_demo, mfi_kitchen_sink_demo |
| HexGrid | filters/hex_grid.wgsl | 1 | qbert_demo |
| HSV | filters/hsv.wgsl | 6 | wgsl_filters_demo, nyan_trail_demo, chromatic_ghosts, subtractive_drone, hsv_demo (+1 more) |
...
| Pixelate | filters/pixelate.wgsl | 3 | wgsl_filters_demo, chromatic_ghosts, subtractive_drone |
| Posterize | filters/posterize.wgsl | 5 | wgsl_filters_demo, chromatic_ghosts, subtractive_drone, mfi_kitchen_sink_demo, mfi_posterize_demo |
...
| Scanlines | filters/scanlines.wgsl | 4 | scanlines_demo, wgsl_filters_demo, chromatic_ghosts, subtractive_drone |
...
| Transform | filters/transform.wgsl | 4 | wgsl_filters_demo, path_animate_av_demo, transform_demo, path_animate_demo |
...
| GateAudio | control | operators/control/gate/gate.cpp |
...
| MsegAudio | control | operators/control/mseg/mseg.cpp |
...
| PatternSeq | control | operators/control/pattern_seq/pattern_seq.cpp |
| PhaseToMidi | control | operators/control/phase_to_midi/phase_to_midi.cpp |
| Quantizer | control | operators/control/quantizer/quantizer.cpp |
...
| SampleHoldAudio | control | operators/control/sample_hold/sample_hold.cpp |
...
| Tracker | control | operators/control/tracker/tracker.cpp |
