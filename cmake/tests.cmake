...
add_vivid_test_fixture(test_op_v1     tests/operators/test_op_v1.cpp)
add_vivid_test_fixture(test_op_v2     tests/operators/test_op_v2.cpp)
...
add_vivid_test_fixture(test_op_advanced_port tests/operators/test_op_advanced_port.cpp)
...
add_vivid_test_fixture(audio_reload_v3 tests/operators/audio_reload_v3.cpp)
add_vivid_test_fixture(audio_reload_incompatible tests/operators/audio_reload_incompatible.cpp)
add_vivid_test_fixture(export_custom_port_op tests/operators/export_custom_port_op.cpp)
add_vivid_test_fixture(test_state_carry_op tests/operators/test_state_carry_op.cpp)
add_vivid_test_fixture(string_source_op tests/operators/string_source_op.cpp)
add_vivid_test_fixture(string_sink_op tests/operators/string_sink_op.cpp)
add_vivid_test_fixture(file_drop_test_op tests/operators/file_drop_test_op.cpp)
add_vivid_test_fixture(file_drop_test_op_alt tests/operators/file_drop_test_op_alt.cpp)
add_vivid_test_fixture(file_drop_bad_param_op tests/operators/file_drop_bad_param_op.cpp)
add_vivid_test_fixture(prepare_assets_test_op tests/operators/prepare_assets_test_op.cpp)
add_vivid_test_fixture(prepare_assets_legacy_op tests/operators/prepare_assets_legacy_op.cpp)
add_vivid_test_fixture(semantic_ms_source_op tests/operators/semantic_ms_source_op.cpp)
add_vivid_test_fixture(semantic_s_dest_op    tests/operators/semantic_s_dest_op.cpp)
add_vivid_test_fixture(semantic_unknown_source_op tests/operators/semantic_unknown_source_op.cpp)
add_vivid_test_fixture(untagged_dest_op          tests/operators/untagged_dest_op.cpp)

# Additional test-only fixture operators consumed by the grouped test includes.
add_vivid_test_fixture(audio_test_op      tests/operators/audio_test_op.cpp)
add_vivid_test_fixture(audio_scalar_probe_op tests/operators/audio_scalar_probe_op.cpp)
add_vivid_test_fixture(audio_throwing_op  tests/operators/audio_throwing_op.cpp)
add_vivid_test_fixture(control_pass_op    tests/operators/control_pass_op.cpp)
add_vivid_test_fixture(lane_source_op   tests/operators/lane_source_op.cpp)
add_vivid_test_fixture(lane_sink_op     tests/operators/lane_sink_op.cpp)
add_vivid_test_fixture(lane_metadata_op       tests/operators/lane_metadata_op.cpp)
add_vivid_test_fixture(lane_metadata_audio_op tests/operators/lane_metadata_audio_op.cpp)
add_vivid_test_fixture(lane_smooth_op         tests/operators/lane_smooth_op.cpp)
add_vivid_test_fixture(lane_slew_op           tests/operators/lane_slew_op.cpp)
add_vivid_test_fixture(identity_lane_source_op tests/operators/identity_lane_source_op.cpp)
add_vivid_test_fixture(lane_state_tracker_op     tests/operators/lane_state_tracker_op.cpp)
add_vivid_test_fixture(multi_channel_dc_source_op tests/operators/multi_channel_dc_source_op.cpp)
add_vivid_test_fixture(dc_per_lane_op            tests/operators/dc_per_lane_op.cpp)
add_vivid_test_fixture(lane_frame_op             tests/operators/lane_frame_op.cpp)
add_vivid_test_fixture(audio_lane_op    tests/operators/audio_lane_op.cpp)
add_vivid_test_fixture(audio_reduce_op  tests/operators/audio_reduce_op.cpp)
add_vivid_test_fixture(scalar_source_op  tests/operators/scalar_source_op.cpp)
add_vivid_test_fixture(dual_lane_sink_op tests/operators/dual_lane_sink_op.cpp)
add_vivid_test_fixture(gpu_fill_op      tests/operators/gpu_fill_op.cpp EXTRA_LIBS webgpu)
add_vivid_test_fixture(gpu_metronome_probe_op tests/operators/gpu_metronome_probe_op.cpp EXTRA_LIBS webgpu)

# SIMD smoke operator fixture (Highway when available, scalar fallback)
add_vivid_test_fixture(simd_smoke_op tests/operators/simd_smoke_op.cpp)
