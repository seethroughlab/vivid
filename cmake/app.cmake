...
add_library(vivid_ui STATIC
    ...
    src/ui/graph/operator_layout.cpp
...
# Copy operator semantic-map embeddings to build directory (if present).
# The file is generated by tools/generate_operator_embeddings.py and committed
# to resources/. If it's missing, the Map tab in the operator chooser just
# stays empty — nothing else fails.
if(EXISTS ${CMAKE_SOURCE_DIR}/resources/operator_embeddings.json)
    configure_file(resources/operator_embeddings.json
                   ${CMAKE_BINARY_DIR}/operator_embeddings.json COPYONLY)
endif()
...
if(APPLE)
    ...
    # Operator semantic-map embeddings → Resources/ (optional)
    if(EXISTS ${CMAKE_SOURCE_DIR}/resources/operator_embeddings.json)
        target_sources(vivid PRIVATE resources/operator_embeddings.json)
        set_source_files_properties(resources/operator_embeddings.json
            PROPERTIES MACOSX_PACKAGE_LOCATION Resources)
    endif()
