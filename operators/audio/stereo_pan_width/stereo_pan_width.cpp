...
struct StereoPanWidth : vivid::AudioOperatorBase {
    ...
    void collect_ports(std::vector<VividPortDescriptor>& out) override {
        ...
        out.push_back({"pan_cv",   VIVID_PORT_FLOAT, VIVID_PORT_INPUT,  VIVID_PORT_TRANSPORT_SCALAR, 0, nullptr, 0, 0.0f});
        out.push_back({"width_cv", VIVID_PORT_FLOAT, VIVID_PORT_INPUT,  VIVID_PORT_TRANSPORT_SCALAR, 0, nullptr, 0, 0.0f});
    }
