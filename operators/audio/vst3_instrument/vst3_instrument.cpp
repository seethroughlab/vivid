...
struct Vst3Instrument : vivid::OperatorBase, vivid::AudioProcessable {
    ...
    Vst3Instrument() {
        ...
        vivid::display_hint(macro_0_id, VIVID_DISPLAY_HIDDEN);
        vivid::description(macro_1, "Macro 1 value (0-1)"); vivid::display_hint(macro_1, VIVID_DISPLAY_HIDDEN);
        vivid::description(macro_1_id, "VST3 parameter name for macro 1"); vivid::display_hint(macro_1_id, VIVID_DISPLAY_HIDDEN);
        vivid::description(macro_2, "Macro 2 value (0-1)"); vivid::display_hint(macro_2, VIVID_DISPLAY_HIDDEN);
        vivid::description(macro_2_id, "VST3 parameter name for macro 2"); vivid::display_hint(macro_2_id, VIVID_DISPLAY_HIDDEN);
        vivid::description(macro_3, "Macro 3 value (0-1)"); vivid::display_hint(macro_3, VIVID_DISPLAY_HIDDEN);
        vivid::description(macro_3_id, "VST3 parameter name for macro 3"); vivid::display_hint(macro_3_id, VIVID_DISPLAY_HIDDEN);
        vivid::description(macro_4, "Macro 4 value (0-1)"); vivid::display_hint(macro_4, VIVID_DISPLAY_HIDDEN);
        vivid::description(macro_4_id, "VST3 parameter name for macro 4"); vivid::display_hint(macro_4_id, VIVID_DISPLAY_HIDDEN);
        vivid::description(macro_5, "Macro 5 value (0-1)"); vivid::display_hint(macro_5, VIVID_DISPLAY_HIDDEN);
        vivid::description(macro_5_id, "VST3 parameter name for macro 5"); vivid::display_hint(macro_5_id, VIVID_DISPLAY_HIDDEN);
        vivid::description(macro_6, "Macro 6 value (0-1)"); vivid::display_hint(macro_6, VIVID_DISPLAY_HIDDEN);
        vivid::description(macro_6_id, "VST3 parameter name for macro 6"); vivid::display_hint(macro_6_id, VIVID_DISPLAY_HIDDEN);
        vivid::description(macro_7, "Macro 7 value (0-1)"); vivid::display_hint(macro_7, VIVID_DISPLAY_HIDDEN);
        vivid::description(macro_7_id, "VST3 parameter name for macro 7"); vivid::display_hint(macro_7_id, VIVID_DISPLAY_HIDDEN);
    ...
    void draw_inspector(VividInspectorContext* ctx) override {
        ...
        auto* act = active_.load(std::memory_order_acquire);
        bool has_gui = act && act->controller != nullptr;
