...
struct MovieFileAudio : vivid::OperatorBase, vivid::AudioProcessable {
    ...
    void collect_ports(std::vector<VividPortDescriptor>& out) override {
        ...
        out.push_back({"time",     VIVID_PORT_SIGNAL, VIVID_PORT_OUTPUT, VIVID_PORT_TRANSPORT_SIGNAL, 0, nullptr, 0, 0.0f});
        out.push_back({"duration", VIVID_PORT_SIGNAL, VIVID_PORT_OUTPUT, VIVID_PORT_TRANSPORT_SIGNAL, 0, nullptr, 0, 0.0f});
