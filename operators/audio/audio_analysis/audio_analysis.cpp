...
// them as VIVID_PORT_FLOAT control outputs. This is the Audio→Control bridge,
...
struct AudioAnalysis : vivid::AudioOperatorBase {
    ...
    void collect_ports(std::vector<VividPortDescriptor>& out) override {
        ...
        out.push_back({"rms",               VIVID_PORT_FLOAT, VIVID_PORT_OUTPUT, VIVID_PORT_TRANSPORT_SCALAR, 0, nullptr, 0, 0.0f});
        out.push_back({"peak",              VIVID_PORT_FLOAT, VIVID_PORT_OUTPUT, VIVID_PORT_TRANSPORT_SCALAR, 0, nullptr, 0, 0.0f});
        out.push_back({"spectral_centroid", VIVID_PORT_FLOAT, VIVID_PORT_OUTPUT, VIVID_PORT_TRANSPORT_SCALAR, 0, nullptr, 0, 0.0f});
        out.push_back({"spectral_flux",     VIVID_PORT_FLOAT, VIVID_PORT_OUTPUT, VIVID_PORT_TRANSPORT_SCALAR, 0, nullptr, 0, 0.0f});
        out.push_back({"zero_crossing_rate", VIVID_PORT_FLOAT, VIVID_PORT_OUTPUT, VIVID_PORT_TRANSPORT_SCALAR, 0, nullptr, 0, 0.0f});
    }
