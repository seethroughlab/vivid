...
struct DualFilter : vivid::OperatorBase, vivid::AudioProcessable {
    ...
    void collect_ports(std::vector<VividPortDescriptor>& out) override {
        ...
        out.push_back({.name="a_cutoff_mod", .type=VIVID_PORT_SCALAR, .direction=VIVID_PORT_INPUT, .transport=VIVID_PORT_TRANSPORT_LANE_ARRAY, .semantic_tag="cutoff_mod", .semantic_shape="lane_array", .semantic_intent="per_note_cutoff_mod", .description="Per-lane cutoff modulation for stage A (polyphonic envelopes).", .multiplicity=VIVID_MULTIPLICITY_MANY});
        out.push_back({.name="b_cutoff_mod", .type=VIVID_PORT_SCALAR, .direction=VIVID_PORT_INPUT, .transport=VIVID_PORT_TRANSPORT_LANE_ARRAY, .semantic_tag="cutoff_mod", .semantic_shape="lane_array", .semantic_intent="per_note_cutoff_mod", .description="Per-lane cutoff modulation for stage B (polyphonic envelopes).", .multiplicity=VIVID_MULTIPLICITY_MANY});
        out.push_back({.name="frequencies",  .type=VIVID_PORT_SCALAR, .direction=VIVID_PORT_INPUT, .transport=VIVID_PORT_TRANSPORT_LANE_ARRAY, .semantic_tag="frequency_hz", .semantic_shape="lane_array", .semantic_intent="per_note_frequency", .description="Per-lane note frequencies used for keytracking in polyphonic chains.", .multiplicity=VIVID_MULTIPLICITY_MANY});
