...
struct ChordProgression : vivid::OperatorBase {
    ...
    void compute(float beat_phase, const float* params, VividLaneOutput* output_lanes,
    ...
    void draw_inspector(VividInspectorContext* ctx) override {
        ...
        const char* row_labels[3] = {"Deg", "Voic", "Ext"};
        for (int r = 0; r < 3; ++r) {
            d.draw_text(o, px + 2.0f, base_y + row_tops[1 + r] + 2.0f, row_labels[r],
