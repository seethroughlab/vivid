...
struct Euclidean : vivid::OperatorBase {
    ...
    void collect_ports(std::vector<VividPortDescriptor>& out) override {
        ...
        out.push_back({"trigger",    VIVID_PORT_CONTROL_FLOAT,  VIVID_PORT_OUTPUT});   // out[0]
        out.push_back({"gate",       VIVID_PORT_CONTROL_FLOAT,  VIVID_PORT_OUTPUT});   // out[1]
        out.push_back({"step",       VIVID_PORT_CONTROL_FLOAT,  VIVID_PORT_OUTPUT});   // out[2]
