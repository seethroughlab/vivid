...
struct StepCounter : vivid::ControlOperatorBase {
    ...
    void collect_ports(std::vector<VividPortDescriptor>& out) override {
        ...
        out.push_back({"modulus", VIVID_PORT_FLOAT, VIVID_PORT_INPUT});
        out.push_back({"reset", VIVID_PORT_FLOAT, VIVID_PORT_INPUT});
        out.push_back({"index", VIVID_PORT_FLOAT, VIVID_PORT_OUTPUT});
        out.push_back({"wrapped", VIVID_PORT_FLOAT, VIVID_PORT_OUTPUT});
    }
