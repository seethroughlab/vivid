...
struct StateMachine : vivid::OperatorBase, vivid::AudioProcessable {
    ...
    void collect_ports(std::vector<VividPortDescriptor>& out) override {
        ...
        out.push_back({"bar",      VIVID_PORT_SCALAR, VIVID_PORT_OUTPUT});
        out.push_back({"beat",     VIVID_PORT_SCALAR, VIVID_PORT_OUTPUT});
        out.push_back({"xfade",    VIVID_PORT_SCALAR, VIVID_PORT_OUTPUT});
    }
