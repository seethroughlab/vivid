...
struct Envelope : vivid::AudioOperatorBase {
    ...
    // Attempt shaping for attack stage (concave-up for exponential = fast onset)
    ...
    // Attempt shaping for decay/release stages (fast initial drop for exponential)
