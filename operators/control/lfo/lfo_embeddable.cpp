...
// Embeddable support for ChildOp<LFO>.
//
// LFO's public operator (lfo.cpp) links vivid_embeddable_op_support, so the
// shared thumbnail implementation lives here. Operators that embed LFO via
// ChildOp<LFO> link this same support library and pick up the symbol from
// here instead of recompiling it per consumer.
