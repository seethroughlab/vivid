/*{
  "name": "CRTEffect",
  "params": [
    {"name": "curvature",          "default": 0.3,   "min": 0.0, "max": 1.0},
    {"name": "vignette",           "default": 0.3,   "min": 0.0, "max": 1.0},
    {"name": "scanline_intensity", "default": 0.4,   "min": 0.0, "max": 1.0},
    {"name": "bloom",              "default": 0.2,   "min": 0.0, "max": 1.0},
    {"name": "chromatic",          "default": 0.005, "min": 0.0, "max": 0.05}
  ]
}*/
@fragment
