/*{
  ...
  "params": [
    ...
    {"name": "offset_x",   "default": 0.0,   "min": -1.0, "max": 1.0, "display": "xy_pad"},
    {"name": "offset_y",   "default": 0.0,   "min": -1.0, "max": 1.0, "display": "xy_pad"},
    {"name": "scale",      "default": 1.0,   "min": 0.1, "max": 10.0},
    {"name": "repeat",     "default": 1.0,   "min": 0.1, "max": 10.0},
    {"name": "hue_offset", "default": 0.0,   "min": 0.0, "max": 1.0},
    {"name": "hue_range",  "default": 1.0,   "min": 0.0, "max": 1.0},
    {"name": "saturation", "default": 1.0,   "min": 0.0, "max": 1.0},
    {"name": "brightness", "default": 1.0,   "min": 0.0, "max": 1.0}
  ]
}*/
